...
- **`test_chess_game.cpp`** — ChessGame: lifecycle (endGame, isGameOver, move rejection after game-over, checkmate sets game-over, undo/newGame/loadFEN reset game-over), draw detection, callbacks/batching, history integration, undo/redo, getHistory (coordinate/SAN/LAN).
