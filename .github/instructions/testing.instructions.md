...
└── test_core/
    ...
    └── test_chess_bitboard.cpp           ChessBitboard + ChessAttacks: square mapping, bit ops, square-color masks, leaper tables, slider rays, BitboardSet mutations, computeAttackInfo
```
