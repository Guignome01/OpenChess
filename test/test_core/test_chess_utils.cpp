...
#include "../../lib/core/src/evaluation.h"
...
void test_getPieceColor(void) {
  TEST_ASSERT_ENUM_EQ(Color::WHITE, piece::pieceColor(Piece::W_KING));
  TEST_ASSERT_ENUM_EQ(Color::WHITE, piece::pieceColor(Piece::W_PAWN));
  TEST_ASSERT_ENUM_EQ(Color::BLACK, piece::pieceColor(Piece::B_KING));
  TEST_ASSERT_ENUM_EQ(Color::BLACK, piece::pieceColor(Piece::B_PAWN));
  // pieceColor on NONE is undefined behavior — only check valid pieces
}

void test_isWhitePiece(void) {
  TEST_ASSERT_TRUE(piece::isWhite(Piece::W_KING));
  TEST_ASSERT_TRUE(piece::isWhite(Piece::W_QUEEN));
  TEST_ASSERT_FALSE(piece::isWhite(Piece::B_KING));
  TEST_ASSERT_FALSE(piece::isWhite(Piece::NONE));
}

void test_isBlackPiece(void) {
  TEST_ASSERT_TRUE(piece::isBlack(Piece::B_KING));
  TEST_ASSERT_TRUE(piece::isBlack(Piece::B_QUEEN));
  TEST_ASSERT_FALSE(piece::isBlack(Piece::W_KING));
  TEST_ASSERT_FALSE(piece::isBlack(Piece::NONE));
}

void test_colorName(void) {
  TEST_ASSERT_EQUAL_STRING("White", piece::colorName(Color::WHITE));
  TEST_ASSERT_EQUAL_STRING("Black", piece::colorName(Color::BLACK));
}
...
void test_opponentColor_white(void) {
  TEST_ASSERT_EQUAL_STRING("Black", piece::colorName(~Color::WHITE));
}

void test_opponentColor_black(void) {
  TEST_ASSERT_EQUAL_STRING("White", piece::colorName(~Color::BLACK));
}
...
void test_pawnDirection_white(void) {
  TEST_ASSERT_EQUAL_INT(-1, piece::pawnDirection(Color::WHITE));
}

void test_pawnDirection_black(void) {
  TEST_ASSERT_EQUAL_INT(1, piece::pawnDirection(Color::BLACK));
}
...
void test_homeRow_white(void) {
  TEST_ASSERT_EQUAL_INT(7, piece::homeRow(Color::WHITE));
}

void test_homeRow_black(void) {
  TEST_ASSERT_EQUAL_INT(0, piece::homeRow(Color::BLACK));
}
