...
└── test_core/
    ...
    ├── test_chess_utils.cpp        FEN round-trip, evaluation, piece color helpers, 50-move rule, castling rights strings
