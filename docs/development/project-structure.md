...
| `stockfish_settings.h` | 8 difficulty presets (beginner through master, depths 3–17, scaled timeouts 10s–65s). `StockfishSettings::fromLevel(int)` factory. `BotConfig` struct bundles settings + player color. |
