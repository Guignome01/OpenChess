...
- **Documentation** — keep `README.md`, `.claude/CLAUDE.md`, and `.github/copilot-instructions.md` in sync with architectural changes. When adding a new subsystem, document its purpose, lifecycle, and integration points in these files. Code comments explain *why*, not *what*.